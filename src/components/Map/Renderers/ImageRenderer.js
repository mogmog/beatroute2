...
export default class ImageRenderer extends AbstractRenderer{
    ...
    setup (context) {
        ...
        for (let i = 0; i < this.images3dArray.length; i++ )
        {
            ...
            externalRenderers.toRenderCoordinates(view, image3d.config.position, 0, SpatialReference.WGS84, pos, 0, 1);
            image3d.position.set(pos[0], pos[1], pos[2]);

            let transform = new THREE.Matrix4();
            let arr = externalRenderers.renderCoordinateTransformAt(view, image3d.config.position, SpatialReference.WGS84, new Array(16));
